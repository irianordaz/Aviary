...
class MultiEngineTableBuilder(EngineModel):
    ...
    def __init__(
        self, name: str = 'multi_engine_table', phase_engine_map: dict = None
    ):
    ...
    def configure_phase_info(
        ...
        for phase_name, phase_opts in phase_info.items():
            ...
            phase_opts['subsystem_options'][propulsion_name].setdefault(
                self.name, {}
            )
    ...
    def build_pre_mission(self, aviary_inputs, subsystem_options=None):
        ...
        return self._default_engine().build_pre_mission(
            aviary_inputs, subsystem_options
        )
