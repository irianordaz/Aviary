        ...
        if self.problem_ran_successfully and self.problem_type is ProblemType.SIZING:
            ...
            if (
                ...
                if phase_info['cruise']:
                    min_duration = phase_info['cruise']['user_options']['duration_bounds'][0][0]
                    max_duration = phase_info['cruise']['user_options']['duration_bounds'][0][1]
                    cruise_units = phase_info['cruise']['user_options']['duration_bounds'][1]
                    ...
                    phase_info['cruise']['user_options'].update(
                        {'duration_bounds': ((min_duration, 2 * max_duration), cruise_units)}
                    )
